...
// nested in that property's own route subtree) can offer a way back to
// it — see PropertyBackLink.jsx. Written here, once, so any current or
// future property brand gets this for free just by being wrapped in
// <BrandProvider>; no per-screen wiring needed.
