...
export const MODULES = [
  ...
  { id: 'front',       label: 'フロント',         icon: 'ti-key',            path: '/front',       status: 'soon',   notifiable: true,  desc: 'チェックイン・チェックアウト・客室状況' },
  { id: 'cleaning',    label: '清掃',             icon: 'ti-sparkles',       path: '/cleaning',    status: 'soon',   notifiable: true,  desc: '客室清掃の状況管理' },
  { id: 'breakfast',   label: '朝食',             icon: 'ti-coffee',         path: '/breakfast',   status: 'soon',   notifiable: true,  desc: '朝食のメニュー・在庫・発注・原価・売上(将来拡張)' },
  { id: 'dinner',      label: '夕食',             icon: 'ti-moon',           path: '/dinner',      status: 'soon',   notifiable: true,  desc: '夕食のメニュー・在庫・発注・原価・売上(将来拡張)' },
  { id: 'maintenance', label: '設備',             icon: 'ti-tools',          path: '/maintenance', status: 'soon',   notifiable: true,  desc: '設備の修繕・故障対応の記録' },
  ...
  { id: 'documents',   label: '書類管理',         icon: 'ti-folder',        path: '/documents',   status: 'soon',   notifiable: true,  desc: '規程・マニュアル等の文書管理(フロント分類)' },
  { id: 'staff',       label: '社員情報',         icon: 'ti-users',         path: '/employees',   status: 'active', notifiable: false, absolute: true, desc: '大栄商事の社員管理を参照(参照のみ)' },
  { id: 'settings',    label: '拠点設定',         icon: 'ti-settings',      path: '/settings',    status: 'soon',   notifiable: false, desc: 'この拠点全体の設定' },
]
