...
// A single property's hub (today: リコホテル三国), rendered as the
// default "ホーム" content inside the property's SidebarShell (see
// HotelsApp.jsx) — the shell already provides Header+persistent
// sidebar, so this is just the page content, no wrapper of its own.
// MODULES entries are single-segment paths (e.g. '/sales') meant to be
// appended to this property's own base path, so navigation composes
// `brand.homePath + m.path` — unlike the company Portal, whose
// registry paths are already complete top-level paths.
